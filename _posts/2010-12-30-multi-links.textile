...
description: JQuery plugin that lets you add hover effects to all links to the same href. Idea directly taken from http://csswizardry.com/2010/12/remote-controlled-hyperlinks-or-multiple-links-in-one-hyperlink/, credits to 
head: '
...
{% highlight javascript %} jQuery.multilinks(); {% endhighlight %}
